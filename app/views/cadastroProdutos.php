      ...
      <div class="col-lg-6">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form>
              <div class="row mb-3">
                <label for="inputText" class="col-sm-2 col-form-label">Produto</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control">
                </div>
              </div>
              <div class="row mb-3">
                <label for="inputEmail" class="col-sm-2 col-form-label">Nome reduzido</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control">
                </div>
              </div>
              <div class="row mb-3">
                <label for="inputNumber" class="col-sm-2 col-form-label">Quantidade em estoque</label>
                <div class="col-sm-10">
              ...
              <div class="row mb-3">
                <label for="inputNumber" class="col-sm-2 col-form-label">Imagens</label>
                <div class="col-sm-10">
